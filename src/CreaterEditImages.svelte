<script lang="ts">
  ...
  const title = "Edita tu";
  const boldTitle = "IMÁGEN";
  const subtitle = "Sube una imagen y quítale el fondo rápidamente. Descárgala como PNG sin fondo, lista para usar en cualquier proyecto.";
