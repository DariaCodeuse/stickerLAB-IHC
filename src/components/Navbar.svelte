...
<nav class="bg-tapiz p-4 flex justify-between items-center relative">
  <!-- Logo -->
  <div class="flex items-center space-x-4">
    <a href="/">
      <img
        src="/logo.png"
        alt="Stickers Lab Logo"
  ...
  <div class="flex items-center space-x-4">
    ...
    <a
      href="/registrate"
      class="bg-primario text-silver font-medium py-2 px-4 rounded-md"
      >Regístrate</a
    >
    ...
    <div class="relative">
      ...
      {#if $isOpen}
        <div
          class="absolute right-0 mt-2 w-48 bg-silver rounded-md shadow-lg py-2 z-50"
        >
